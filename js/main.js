function init() {
    ...
    d3.json("data/data.json", function(error, realizations) {
        ...
        var i, j, disks, games, all_points = [], csv_data = [], run_all = false;
...
//                    }
                    ...
                    if (word == 'link'){
                        ...
                        word = "<a href ='https://www.predictionx.org/' id='"+text_class+"'>"+word+"</a>";
                    }
                    line.push(word);
                    if (idx == 0){
...
//    console.log(header);
      var header = "position on board, numbers of times the position was hit" + opts.eol;
...
//            else if ((bins < 4 && maxfreq < 5) || maxfreq > 6 || bins === 3 || maxfreq == 1){
            else {
